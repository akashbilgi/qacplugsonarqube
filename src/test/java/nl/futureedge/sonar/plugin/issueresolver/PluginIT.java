...
public class PluginIT {
	...
	private final class ExportQuery extends Query<Model> {
		...
		public static final String BASE_URL = "/" + IssueResolverWebService.CONTROLLER_PATH + "/" + RunAction.ACTION;
		...
		public String getUrl() {
			...
			url.append('?');
			appendUrlParameter(url, RunAction.PARAM_PROJECT_KEY, projectKey);
			return url.toString();
		}
	}
